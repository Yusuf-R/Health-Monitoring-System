...
import CreateTipsAndGuides from "@/components/HealthWorkerComponents/NewsHub/TipsAndGuides/CreateTipsAndGuides/CreateTipsAndGuides";

function createTipsGuides() {
    ...
    return (
        <>
            <Suspense fallback={<LazyLoading/>}>
                <CreateTipsAndGuides healthWorkerProfile={effectiveHealthWorkerData}/>
            </Suspense>
...
export default createTipsGuides;