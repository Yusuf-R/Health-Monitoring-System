...
function ViewLocation({userProfile}) {
    ...
    const [activeTab, setActiveTab] = useState('/user/profile/location/view');
    ...
    const setLocation = async () => {
        router.push(`/user/profile/location/set`);
    };

    const onEdit = (objId) => {
        useLocationStore.getState().setGeoId(objId);
        router.push('/user/profile/location/edit');
    };
            ...
            >
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        router.push('/user/profile/location/set'); // Navigate to route
                    }}
                    color="primary"
                    size="large"
