...
export default function Feeds({userProfile}) {
    ...
    const filteredFeeds = selectedType === "all"
        ? feeds
        : feeds.filter(feed => feed.type === selectedType);
                                    ...
                                    <CardContent>
                                        ...
                                        {feed.poll ? (
                                            ...
                                            <>
                                                ...
                                                <Button
                                                    variant="text"
                                                    onClick={() => router.push(`/user/info-hub/feeds/${feed.id}`)}
                                                    sx={{
                                                        color: '#46F0F9',
                                                        fontWeight: 'bold',
                                                        '&:hover': {
