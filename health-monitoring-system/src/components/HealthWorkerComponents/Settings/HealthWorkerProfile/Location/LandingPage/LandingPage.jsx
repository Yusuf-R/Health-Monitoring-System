...
function LandingPage() {
    const [activeTab, setActiveTab] = useState('/health-worker/settings/profile/location');
    ...
    const headerItems = [
        { title: 'View-Saved Locations', src: '/view-location.svg', route: '/health-worker/settings/profile/location/view' },
        { title: 'Set-New Locations', src: '/saved-location.svg', route: '/health-worker/settings/profile/location/set' },
    ];
