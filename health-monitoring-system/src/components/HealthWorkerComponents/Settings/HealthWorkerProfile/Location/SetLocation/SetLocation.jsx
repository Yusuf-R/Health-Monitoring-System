...
function SetLocation({healthWorkerProfile}) {
    ...
    const {control, handleSubmit, setValue, formState: {errors}} = useForm({
        mode: "onTouched",
        resolver: zodResolver(setLocationValidator),
    ...
    const initialLocation = healthWorkerProfile.geoLocation?.[0]
        ? {lat: healthWorkerProfile.geoLocation[0].latitude, lng: healthWorkerProfile.geoLocation[0].longitude}
        : {lat: 6.5244, lng: 3.3792};

    const [currentLocation, setCurrentLocation] = useState(initialLocation);
    const [locationCoords, setLocationCoords] = useState(null);
    const [savedLocations, setSavedLocations] = useState(healthWorkerProfile.geoLocation || []);
    ...
    const mutationUpdate = useMutation({
        mutationKey: ["setHealthWorkerLocation"],
        mutationFn: AdminUtils.setHealthWorkerLocation,
    });
    ...
    const handleSubmitLocation = (newLocation) => {
        ...
        mutationUpdate.mutate(data, {
            onSuccess: (response) => {
                ...
                router.push('/health-worker/settings/profile/location/view');
                setOpenModal(false);
            },
            onError: (error) => {
