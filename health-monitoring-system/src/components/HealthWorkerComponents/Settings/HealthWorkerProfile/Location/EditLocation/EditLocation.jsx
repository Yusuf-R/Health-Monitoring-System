...
function EditLocation({healthWorkerProfile, geoId}) {
    ...
    const editableLocation = healthWorkerProfile.geoLocation.find(location => location._id === geoId);
    ...
    const mutationUpdate = useMutation({
        ...
        mutationFn: AdminUtils.editHealthWorkerLocation,
    });
    ...
    const handleSubmitLocation = (newLocation) => {
        ...
        mutationUpdate.mutate(data, {
            onSuccess: (response) => {
                ...
                router.push('/health-worker/profile/location/view');
                setOpenModal(false);
            },
            onError: (error) => {
