...
const features = [
    {
        ...
        icon: <SymptomIcon/>,
        route: '/health-worker/personalized/logger/symptom-logger',
        btnColor: '#4CAF50',
    },
    {
        title: "View Insights",
        icon: <InsightsIcon/>,
        route: '/health-worker/personalized/logger/insights',
        btnColor: '#007FFF',
    },
    {
        title: "Activities",
        icon: <ActivitiesIcon/>,
        route: '/health-worker/personalized/logger/activity-tracker',
        btnColor: '#00BCD4',
    },
    {
        title: "Connect with Doctors",
        icon: <HospitalIcon/>,
        route: '/health-worker/tools/chat',
        btnColor: '#9C27B0',
    },
];
...
function SymptomLogger({healthWorkerProfile}) {
    const [selectedTab, setSelectedTab] = useState('/health-worker/personalized/logger/symptom-logger');
    ...
    const handleFormSubmit = async () => {
        ...
        try {
            ...
            const symptomDoc = await addDoc(symptomsCollection, {
                healthWorkerId: healthWorkerProfile?._id || 'anonymous',
                symptomDetails,
                symptomIntensity,
                impact,
                possibleCauses,
...
Continue monitoring your symptoms and log any changes. If your condition worsens, please update your symptoms and request healthcare provider contact.`,
    ...
    useEffect(() => {
        if (selectedTab === '/health-worker/personalized/logger/symptom-logger') {
